...
AutostartSetupConsole="Einloggen zum rpidatv Menu"
AutostartSetupDisplay="Einloggen zum Start des Touchscreen Display"
AutostartSetupButton="Einloggen zur Freigabe Tastenbedienung"
